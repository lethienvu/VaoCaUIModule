...
class UIElements_VaoCa {
    ...
    _injectStyles() {
        ...
        style.innerHTML = `
            ...
            /* Base Popup Styling */
            .VC-Vu-popup {
                width: 50%; /* Adjusted from 200px/250px to be responsive */
     ...
     */
    showConfirmPopup({ title = "Thông báo", content = "Nội dung popup", iconSvg = '', onConfirm = null, onCancel = null }) {
     ...
     */
    showInfoPopup({ title = "Thông báo", content = "", iconSvg = '', onOk = null }) {
