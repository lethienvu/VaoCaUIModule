...
class UIElements_VaoCa {
  ...
  _setupConfirmPopupEvents(overlay) {
    ...
    // Note: Removed overlay click handler and exitBtn handler to force user to choose an option
  }
